...
<html lang="en-us" id="lock-page">
    ...
    <body>
        ...
        <div id="main" role="main">
            ...
            <!-- MAIN CONTENT -->
            {{ Form::open( ['route' => 'sessions.store','class' =>'lockscreen animated flipInY']) }}

            <div class="logo">
                <h1 class="semi-bold"><i class="fa fa-clock-o"> </i> Hours Controll </h1>
            </div>
            <div>
<!--                    <img src="img/avatars/sunny-big.png" alt="" width="120" height="120" />-->
 ...
 <div class="input-group-btn">
                            <button class="btn btn-primary" type="submit" name="submit" style="width: 50px;">
