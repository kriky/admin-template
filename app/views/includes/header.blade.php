...
<!--			 #PROJECTS: projects dropdown 
			...
			<div class="pull-right">
				...
				<div id="logout" class="btn-header transparent pull-right">
					<span> <a href="/logout" title="Odjava" data-action="userLogout" data-logout-msg="Jeste li sigurani da se želite odjaviti iz programa?"><i class="fa fa-sign-out"></i></a> </span>
				</div>
				<!-- end logout button -->
